...
== First Step: Set Your Username and GUID!

Look in the box at the top of your screen. Is your username and guid assigned to you set already? If so it will look like this:

image::alreadyset.png[Set User ID above, 700]

If your username and guid is properly set, then you can move on. **If not, in the above box, enter the user ID and GUID you were assigned** like this:
