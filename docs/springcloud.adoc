...
oc new-app openshift/postgresql:latest \
            ...
            --labels='app.kubernetes.io/part-of=vets-app,app.kubernetes.io/instance=vets-database'
----
...
oc new-app -e POSTGRESQL_USER=visits \
    ...
    --labels='app.kubernetes.io/part-of=visits-app,app.kubernetes.io/instance=visits-database'
----
...
oc new-app -e POSTGRESQL_USER=customers \
    ...
    --labels='app.kubernetes.io/part-of=customers-app,app.kubernetes.io/instance=customers-database'
----
...
. Display the current OpenShift project
+
----
oc project
----
...
. Select the OpenShift project that you listed in the previous project.

. Select the *Developer* perspective
+
image::microservice/navigate-to-developer-console.png[]

. Select the *Topology* view 
+
image::microservice/topology-view.png[]
