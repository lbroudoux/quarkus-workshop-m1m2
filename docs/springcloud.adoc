...
Quarkus offers the ability to automatically generate OpenShift resources based on default and user supplied configuration. The OpenShift extension provides sensible defaults so that it’s easier for the user to get started with Quarkus on OpenShift.
...
image::microservices/visits-service-architecture.png[]
...
image::microservices/customers-service-architecture.png[]
...
This is architecture of the petclinic-web-v2 application.
