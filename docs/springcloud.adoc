...
image::images/microservices/swagger-start.png[width="400"]
...
+
image::images/microservices/swagger-start.png[width="600"]
...
image::images/microservices/swagger-results.png[width="600"]
...
image::images/microservices/swagger-global-api-info.png[width="600"]
