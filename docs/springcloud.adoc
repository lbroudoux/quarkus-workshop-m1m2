...
. In your terminal window, move to the directory for the `cpetclinic-web-v2`:
+
[source,sh,role="copypaste"]
----
...
[INFO] Scanning for projects...
[INFO] 
[INFO] -----------------< org.acme:quarkus-petclinic-web-v2 >------------------
[INFO] Building quarkus-petclinic-web-v2 1.0.0-SNAPSHOT
[INFO] --------------------------------[ jar ]---------------------------------
...
...
INFO] [io.quarkus.kubernetes.deployment.KubernetesDeployer] Applied: ServiceAccount quarkus-petclinic-web-v2.
[INFO] [io.quarkus.kubernetes.deployment.KubernetesDeployer] Applied: Service quarkus-petclinic-web-v2.
[INFO] [io.quarkus.kubernetes.deployment.KubernetesDeployer] Applied: ImageStream openjdk-11.
[INFO] [io.quarkus.kubernetes.deployment.KubernetesDeployer] Applied: ImageStream quarkus-petclinic-web-v2.
[INFO] [io.quarkus.kubernetes.deployment.KubernetesDeployer] Applied: BuildConfig quarkus-petclinic-web-v2.
[INFO] [io.quarkus.kubernetes.deployment.KubernetesDeployer] Applied: DeploymentConfig quarkus-petclinic-web-v2.
[INFO] [io.quarkus.kubernetes.deployment.KubernetesDeployer] Applied: Route quarkus-petclinic-web-v2.
[INFO] [io.quarkus.kubernetes.deployment.KubernetesDeployer] The deployed application can be accessed at: http://quarkus-petclinic-web-v2-quarkus-lmhzb-project.apps.cluster-twbr9.twbr9.sandbox1759.opentlc.com
