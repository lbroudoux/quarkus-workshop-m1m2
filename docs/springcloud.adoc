...
[source,sh,role="copypaste"]
----
curl http://$(oc get route vets-service -o=go-template --template='&lbrace;&lbrace; .spec.host &rbrace;&rbrace;')/vets
----
...
[source,sh,role="copypaste"]
----
echo http://$(oc get route vets-service -o=go-template --template='&lbrace;&lbrace; .spec.host &rbrace;&rbrace;')/swagger-ui
----
...
[source,sh,role="copypaste"]
----
curl http://$(oc get route visits-service -o=go-template --template='&lbrace;&lbrace; .spec.host &rbrace;&rbrace;')/pets/visits?petIds=8
----
...
[source,sh,role="copypaste"]
----
echo http://$(oc get route visits-service -o=go-template --template='&lbrace;&lbrace; .spec.host &rbrace;&rbrace;')/swagger-ui
----
...
[source,sh,role="copypaste"]
----
curl http://$(oc get route customers-service -o=go-template --template='&lbrace;&lbrace; .spec.host &rbrace;&rbrace;')/owners
----
...
[source,sh,role="copypaste"]
----
echo http://$(oc get route customers-service -o=go-template --template='&lbrace;&lbrace; .spec.host &rbrace;&rbrace;')/swagger-ui
----
...
[source,sh,role="copypaste"]
----
echo http://$(oc get route petclinic-web-v2 -o=go-template --template='&lbrace;&lbrace; .spec.host &rbrace;&rbrace;')
----
