...
To distinguish 2 Petclinic application easily, you see *Red Hat Runtimes* and *Quarkus* logos on the welcome page. For example, when you mouseover the _Quarkus logo_ on the left top of the page, you should see it changes a dark blue Quarkus logo:

image::quarkus-petclinic-home-change.png[quarkus-petclinic, 900]

=== Add the Owners Template and Contents
