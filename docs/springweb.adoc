...
You've learned how to refactor _Spring Web_ to _Quarkus_ using *Qute Templating Engine*. Note that Qute technology is still considered experimental and you can find more https://quarkus.io/guides/qute-reference[Qute Reference Guide^] on how to use syntax, build blocks, integration, etc.
