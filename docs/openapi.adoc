...
----
mvn -q quarkus:add-extension -Dextensions="openapi" -f $CHE_PROJECTS_ROOT/quarkus-workshop-labs
----
...
Since our app is still running, click on the `web-quarkus-{{ GUID }}` link on the right to open the app's landing page in your browser:
